      ...
      <Box zIndex={1}>
        ...
        >
          <Stack px={8} gridGap={4} w={"100%"} justify="center" >
            <VStack >
              <Heading color="white" fontSize="8xl" fontWeight="bold" >Chakra UI</Heading>
              <Heading color="white" fontSize="6xl" fontWeight="bold">
                <Tooltip rounded="2xl" label="& Tips集" defaultIsOpen={true} fontSize="5xl" isOpen={true} placement="bottom" hasArrow p={4} px={16} m={4}>
